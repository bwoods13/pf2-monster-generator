...
export class NewMonsterGeneratorComponent implements OnInit {
  ...
  skillMods: any = 	[ [ '+8',  '+5',	 '+4',	  '+2 to +1'], // Level -1
                      [ '+9',	 '+6',	 '+5',	  '+3 to +2'], // Level 0
                      ['+10',	 '+7',	 '+6',	  '+4 to +3'], // Level 1
                      ['+11',	 '+8',	 '+7',	  '+5 to +4'], // Level 2
                      ['+13',	'+10',	 '+9',	  '+7 to +5'], // Level 3
                      ['+15',	'+12',	'+10',	  '+8 to +7'], // Level 4
                      ['+16',	'+13',	'+12',	 '+10 to +8'], // Level 5
                      ['+18',	'+15',	'+13',	 '+11 to +9'], // Level 6
                      ['+20',	'+17',	'+15',	'+13 to +11'], // Level 7
                      ['+21',	'+18',	'+16',	'+14 to +12'], // Level 8
                      ['+23',	'+20',	'+18',	'+16 to +13'], // Level 9
                      ['+25',	'+22',	'+19',	'+17 to +15'], // Level 10
                      ['+26',	'+23',	'+21',	'+19 to +16'], // Level 11
                      ['+28',	'+25',	'+22',	'+20 to +17'], // Level 12
                      ['+30',	'+27',	'+24',	'+22 to +19'], // Level 13
                      ['+31',	'+28',	'+25',	'+23 to +20'], // Level 14
                      ['+33',	'+30',	'+27',	'+25 to +21'], // Level 15
                      ['+35',	'+32',	'+28',	'+26 to +23'], // Level 16
                      ['+36',	'+33',	'+30',	'+28 to +24'], // Level 17
                      ['+38',	'+35',	'+31',	'+29 to +25'], // Level 18
                      ['+40',	'+37',	'+33',	'+31 to +27'], // Level 19
                      ['+41',	'+38',	'+34', 	'+32 to +28'], // Level 20
                      ['+43',	'+40',	'+36',	'+34 to +29'], // Level 21
                      ['+45',	'+42',	'+37',	'+35 to +31'], // Level 22
                      ['+46',	'+43',	'+38',	'+36 to +32'], // Level 23
                      ['+48',	'+45',	'+40',	'+38 to +33']]; // Level 24
